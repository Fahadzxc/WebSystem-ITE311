                ...
                <div class="card shadow-sm border-0 mt-4">
                    <div class="card-header bg-primary-custom text-white rounded-top-3">
                        <h5 class="mb-0 fw-bold">
                            <i class="fas fa-question-circle me-2"></i>Multiple Choice Questions (<?= count($questions) ?>)
                        </h5>
                    </div>
                    <div class="card-body">
                        <?php if (!$submission): ?>
                            <form action="<?= base_url('assignment/submit/' . $assignment['id']) ?>" method="post" enctype="multipart/form-data" id="assignmentForm">
                                ...
                                <div class="alert alert-info">
                                    ...
                                    <strong>Note:</strong> This assignment will be auto-graded. Once submitted, you cannot modify your answers. Please review carefully before submitting.
                                </div>
